...
<form action="modify" method="post" id="modiContent">
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" id="title" name="rTitle" value="${rContentView.rTitle}">
	</div>
	<div class="form-group">
		<label for="content">내용</label>
		<textarea class="form-control" id="rcontent" name="rContent" rows="10">
		${rContentView.rContent}
		</textarea>
	</div>
	<button type="submit" id="modi" class="btn btn-success">수정</button>&nbsp;&nbsp; 
	<a href="rdelete?rbId=${rContentView.rbId}" id="contentDel" class="btn btn-danger">삭제</a> &nbsp;&nbsp;
	<a id="contentReplyView" href="replyView?rbId=${rContentView.rbId}" class="btn btn-inline-primary">댓글 작성</a>	
</form>
...
$(document).ready(function(){
	...
	let uemail = '${rContentView.uEmail}';
