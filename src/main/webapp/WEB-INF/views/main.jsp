...
<div class="text-center">
	<a class="container text-center" href="main"><img src="media/LOGO.jpg" alt="회사 로고"></a>
</div>
<!--navigation-->
<nav class="navbar navbar-expand-lg container sticky-top">
	...
	<div class="collapse navbar-collapse justify-content-center text-center" id="collapsibleNavbar">
		<ul class="navbar-nav bi-top-nav02">
			...
			<li class="mymenu nav-item">
				<a class="nav-link text-muted newView" href="newView">New</a>
			</li>
			<li class="mymenu nav-item">
				<a class="nav-link text-muted bestView" href="bestView">Best</a>
			</li>
			...
			<sec:authorize access="isAnonymous()">
	 		...
	 		<sec:authorize access="hasAnyRole('ROLE_ADMIN', 'ROLE_MANAGE')">
				<li class="mymenu nav-item">
					<a class="nav-link text-danger" href="productManager">판매관리</a>
				</li>
			</sec:authorize> 
			<sec:authorize access="isAuthenticated()">
				<li class="nav-item mymenu">
...
<div id="mainRegion" class="container mt-1">
	...
	<div class="row">
		<c:forEach items="${bestList}" var="bestp">
			<div class="col-md-4 my-3" style="hight:auto;">
				<div class="card">
					<a href="bestView" class="bestView">
