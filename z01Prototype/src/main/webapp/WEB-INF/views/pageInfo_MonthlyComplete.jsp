...
$(document).ready(function(){
	...
	$.ajax({
		...
		success: function(result){
			...
			createChart();
			document.getElementById("monthlyCompleteCurrent").classList.remove("btn-outline-dark");
			document.getElementById("monthlyCompleteCurrent").classList.add("btn-dark");
			document.getElementById("monthlyCompleteCurrent").setAttribute("disabled","disabled");
		},
		error: function(){
			alert("monthly complete line graph: 서버접속 실패");
		}
	});
