...
public class MonthlyCompleteCommand implements PTCommand {

	@Override
	public void execute(HttpServletRequest request, Model model) {
		PTBoardDao bdao = Constant.bdao;
		ArrayList<MonthlyOrderDto> dtos = bdao.monthlyCompleteData();
		model.addAttribute("monthlyCompleteList",dtos);
	}
