...
$(document).ready(function(){
	...
	$("#searchInput").on("keyup",function(){
		...
		$("#searchOrderTable tr").filter(function(){
	...
	$("#json").on("click",function(){
		$("#orderReadyTable").tableHTMLExport({
			type:'json',
//			ignoreRow: document.querySelectorAll("tr.style[display='none']"),
			filename: currentYYMMDD("json")+'ordered.json'
		});
	});
	$("#csv").on("click",function(){
		let aaa =document.querySelectorAll("tr.style[display='none']");
		console.log(aaa);
		$("#orderReadyTable").tableHTMLExport({
			type:'csv',
//			ignoreRow: document.querySelectorAll("tr.style[display='none']"),
